...
def _construct_loader(dataset_name, split, batch_size, shuffle, drop_last, data_path=None):
    ...
    if data_path is None: data_path = os.path.join(_DATA_DIR, _PATHS[dataset_name])
